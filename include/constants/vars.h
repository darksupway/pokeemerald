...
#define VAR_ALTERING_CAVE_WILD_SET           0x403E // offset for wildset (if > 8 = offset 0) | 0 = wildset1, 1 = wildset2, ..., 8 = wildset9
...
#define VAR_FORGOTTEN_CAVE_SPECIAL_WILD_SET  0x404E // 0=Mewtwo_Area, 1=Jirachi_Area, 2=Celebi_Area
...
#define VAR_BATTLE_FRONTIER_EAST_STATE       0x4083 // Mostly used for removing ledge to caves
...
#define VAR_MYSTERY_MAN_STATE                0x40DB // 0 = NotTalkedTo, 1 = Introduction, 2 = AuroraTicket, 3 = OldSeaMap, 4 = EonTicket, 5 = MysticTicket, 6 = Forgotten Cave, 7 = Last
#define VAR_REPEL_LAST_USED                  0x40DC
