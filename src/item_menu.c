...
static void ItemMenu_Register(u8 taskId); // changed for LR-register
...
static const struct MenuAction sItemMenuActions[] = {
    ...
    [ACTION_BY_NAME]           = {gMenuText_ByName,   ItemMenu_SortByName},
    [ACTION_BY_TYPE]           = {gMenuText_ByType,   ItemMenu_SortByType},
    [ACTION_BY_AMOUNT]         = {gMenuText_ByAmount, ItemMenu_SortByAmount},
    ...
    if (MenuHelpers_ShouldWaitForLinkRecv() != TRUE && !gPaletteFade.active)
    {
        ...
        default:
            ...
            else if (JOY_NEW(START_BUTTON))
            {
                ...
                {
                    PlaySE(SE_FAILURE);
                    DisplayItemMessage(taskId, 1, gText_NothingToSort, HandleErrorMessage);
                    break;
                }
        ...
        switch (listPosition)
        {
            ...
            case LIST_CANCEL:
                ...
                {
                    PlaySE(SE_FAILURE);
                    // ?from LR-Register repo? PlaySE(SE_HAZURE);
                    break;
                }
                PlaySE(SE_SELECT);
