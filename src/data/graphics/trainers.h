...
const u32 gTrainerFrontPic_MysteryMan[] = INCBIN_U32("graphics/trainers/front_pics/mystery_man_front_pic.4bpp.lz");
const u32 gTrainerPalette_MysteryMan[] = INCBIN_U32("graphics/trainers/palettes/mystery_man.gbapal.lz");
