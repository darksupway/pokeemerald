...
#define MAP_GROUP_SIDEROUTES_AND_CAVES MAP_GROUP(FORGOTTEN_CAVE_ENTRANCE)
#define MAP_GROUP_FORGOTTEN_CAVE MAP_GROUP(FORGOTTEN_CAVE_ENTRANCE)
        ...
        for (i = 0; gWildMonHeaders[i].mapGroup != MAP_GROUP(UNDEFINED); i++)
        {
            if (MapHasSpecies(&gWildMonHeaders[i], species))
            {
                ...
                case MAP_GROUP_TOWNS_AND_ROUTES:
                    ...
                    break;
                case MAP_GROUP_SIDEROUTES_AND_CAVES:
                case MAP_GROUP_FORGOTTEN_CAVE:
                case MAP_GROUP_DUNGEONS:
                case MAP_GROUP_SPECIAL_AREA:
